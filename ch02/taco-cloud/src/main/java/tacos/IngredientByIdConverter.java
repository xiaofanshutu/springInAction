...
public class IngredientByIdConverter implements Converter<String, Ingredient> {
    ...
    public IngredientByIdConverter() {
        ...
        ingredientMap.put("CHED", new Ingredient("CHED", "Cheddar Cheese", Ingredient.Type.CHEESE));
        ingredientMap.put("JACK", new Ingredient("JACK", "Monterrey Jack Cheese", Ingredient.Type.CHEESE));
